          ...
          <v-bottom-sheet v-model="sheet" persistent class="c-rounded elevation-0">
            <v-img src="../assets/bg/bundan-ust.svg" class="wave-img">
              ...
              >
                <v-btn icon @click="sheet = !sheet">
                  <v-icon :color="!threed ? 'grey darken-3' : '#fe6820'">mdi-close</v-icon>
                </v-btn>
              </v-avatar>
            </v-img>
            <v-sheet height="85vh" elevation="0" class="c-rounded">
                ...
                <div class="product-div mt-0">
                  <v-btn v-if="!threed && this.model" height="30" width="50" rounded color="#fe6820" class="custom-button white--text" @click="threed = !threed">
                    <v-row>
                      <v-avatar
                          class="v-avatar--left"
                          color="white"
